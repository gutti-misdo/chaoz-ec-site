...
session_start();
?>
<link rel="stylesheet" href="./css/card-add.css">
...
<body>
    <div class="container">
        ...
        try {
            ...
            echo '<div class="input-field">', '<h2>カートに商品を追加しました。</h2></div><a href="cart-page.php" class="cart-look-button">カートを見る</a>';
            echo '<br><br>', '<p><a href="home-page.php" class="home-button">ホーム画面へ</a></p>';
        } catch (Exception $e) {
            $pdo->rollBack();
