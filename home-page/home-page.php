        ...
        <div class="top-bar">
            ...
            <nav class="kaden">
                <div class="kaden_inner">
                    <ul class="kaden_menu">
                        <li class="kaden_item">
                            <a class="kaden_link" href="">冷蔵庫</a>
                            <a class="kaden_link" href="">コンロ</a>
                            <a class="kaden_link" href="">掃除機</a>
                            <a class="kaden_link" href="">ドライヤー</a>
                            <a class="kaden_link" href="">洗濯機</a>
                            <a class="kaden_link" href="">スマートフォン</a>
                        </li>
                    </ul>
                </div>
            </nav>
