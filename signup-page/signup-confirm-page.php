...
<head>
    ...
    <link rel="stylesheet" href="signup-confirm-page.css">
</head>
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <form action="signup-finifh-page.php" method="post">
                ...
                <div id="Zipcode" class="display-info">
                    ...
                    <input type="hidden" name="yubin" value="<? $_POST['yubin'] ?>">
                </div>
                ...
                <div id="BN" class="display-info">
                    <?php echo $_POST['BN'] ?>
                    <input type="hidden" name="BN" value="<? $_POST['BN'] ?>">
                </div>

                <label for="RN">部屋番号</label>
                <div id="RN" class="display-info">
                    <?php echo $_POST['RN'] ?>
                    <input type="hidden" name="RN" value="<? $_POST['RN'] ?>">
                </div>


                <button type="button" class="login-button">登録</button>
            </form>
        </div>
    </div>
</body>
